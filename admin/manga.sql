...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2018 at 09:52 AM
...
('ciccio', '427ade9c15ec643751860eba9899355b', 'Ciccio Pasticcio'),
('galta', '427ade9c15ec643751860eba9899355b', 'Marco Galtarossa'),
...
--
-- Dumping data for table `capitoli`
--

INSERT INTO `capitoli` (`id`, `nome`, `numero`, `nomecap`, `dataagg`, `link`) VALUES
(1, 'One-Punch Man', 1, 'Primo', '2018-02-11', 'http://www.mangaeden.com/it/it-manga/onepunch-man/1/1/'),
(2, 'One-Punch Man', 2, 'Secondo', '2018-02-11', 'http://www.mangaeden.com/it/it-manga/onepunch-man/2/1/');
...
INSERT INTO `mipiace` (`manga`, `utente`) VALUES
('Bleach', 'galta'),
('Naruto', 'galta'),
('One-Punch Man', 'galta');
...
--
-- Indexes for table `mipiace`
--
ALTER TABLE `mipiace`
  ADD PRIMARY KEY (`manga`,`utente`),
...
--
-- Constraints for table `mipiace`
--
ALTER TABLE `mipiace`
  ADD CONSTRAINT `mipiace_ibfk_1` FOREIGN KEY (`manga`) REFERENCES `manga` (`nome`),
  ADD CONSTRAINT `mipiace_ibfk_2` FOREIGN KEY (`utente`) REFERENCES `utenti` (`user`);
